...
function ToggleBottomBar() {
    ...
    return (
        <>
            ...
            <CustomMouseSecond />
            <CustomMouseThird />
            <motion.div id="togglebutton" onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} className="md:block fixed hidden z-2 bottom-10 rounded-10 p-[0.2rem] overflow-hidden" animate={{ y: $viewToggle ? "100vw" : 0 }} transition={{ duration: 2, ease: [0.41, 0.15, 0.06, 0.95] }}>
                ...
                <motion.div className={` ${$toggle ? "border-slate" : "border-black"} flex justify-around items-start h-full w-full gap-4 px-10 py-5 rounded-[2.3rem] z-5 bg-bgColor font-italic text-xl text-center transition-all duration-1000`} >
                    <AnimatePresence>
