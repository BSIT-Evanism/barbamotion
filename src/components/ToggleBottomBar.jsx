...
function ToggleBottomBar() {
    ...
    return (
        <>
            <CustomMouse />
            <motion.div id="togglebutton" onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} className="fixed z-2 bottom-20 rounded-10 p-[0.2rem] overflow-hidden" animate={{ x: $viewToggle ? "100vw" : 0 }} transition={{ duration: 2, ease: [0.41, 0.15, 0.06, 0.95] }}>
